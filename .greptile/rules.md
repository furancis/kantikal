# Greptile Rules: Kantikal

## Full Shape

The product is a visual workflow app for music generation. Preserve the complete chain: idea, prompt, lyrics, style, voice/persona, generation batches, comparison, Song Lab, stems, library, cleanup, music-video lane, lipsync QA, and release pack.
...
Full API coverage is a product requirement. If a provider capability exists, it needs a UI mapping, backend mapping, planned state, or explicit unsupported record.
