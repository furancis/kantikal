...
export const apiCoverageEntries: ApiCoverageEntry[] = [
  entry('Create song', 'Creation Canvas batch node', 'provider adapter', 'implemented', 'server', 'generateBatch'),
  entry('Custom mode', 'Prompt/lyrics inspector', 'provider adapter', 'implemented', 'server', 'generateBatch'),
  entry('Instrumental', 'Prompt/lyrics inspector', 'provider adapter', 'implemented', 'server', 'generateBatch'),
  entry('Lyrics generation', 'Lyrics card', 'provider adapter', 'implemented', 'server', 'generateLyrics'),
  entry('Model/version selection', 'Prompt inspector', 'provider adapter', 'implemented', 'server', 'selectModelVersion'),
  ...
  entry('Extend', 'Song Lab timeline', 'provider adapter', 'implemented', 'server', 'extendTrack'),
  entry('Upload and extend audio', 'Song Lab upload rail', 'provider adapter', 'implemented', 'server', 'uploadAndExtend'),
  entry('Cover', 'Song Lab action rail', 'provider adapter', 'implemented', 'server', 'coverTrack'),
  entry('Upload and cover audio', 'Song Lab upload rail', 'provider adapter', 'implemented', 'server', 'uploadAndCover'),
  entry('Remix/recreate', 'Song Lab version branch', 'provider adapter', 'unsupported', 'server', 'remixTrack'),
  entry('Remaster', 'Song Lab version branch', 'provider adapter', 'unsupported', 'server', 'remasterTrack'),
  entry('Replace section', 'Song Lab region editor', 'provider adapter', 'implemented', 'server', 'replaceSection'),
  entry('Add instrumental', 'Song Lab stem composer', 'provider adapter', 'implemented', 'server', 'addInstrumental'),
  entry('Add vocals', 'Song Lab stem composer', 'provider adapter', 'implemented', 'server', 'addVocals'),
  entry('Boost music style', 'Style stack action', 'provider adapter', 'implemented', 'server', 'boostMusicStyle'),
  entry('Generate mashup', 'Song Lab mashup lane', 'provider adapter', 'implemented', 'server', 'generateMashup'),
  entry('Generate sounds', 'Sound design card', 'provider adapter', 'implemented', 'server', 'generateSounds'),
  entry('Stems', 'Stem cards', 'provider adapter', 'implemented', 'server', 'separateStems'),
  entry('MIDI from audio', 'Stem cards', 'provider adapter', 'implemented', 'server', 'generateMidi'),
  ...
  entry('Timestamped lyrics', 'Lyrics card timeline', 'provider adapter', 'implemented', 'server', 'getTimestampedLyrics'),
  ...
  entry('Provider music video creation', 'MV lane', 'provider adapter', 'implemented', 'server', 'createProviderMusicVideo'),
