import type { providerWorkflow } from '../domain/workflow'

export type ProviderExportSnapshot = {
  projectId: string
  projectAssets: providerWorkflow['projectAssets']
  exports: providerWorkflow['exports']
  jobQueue: providerWorkflow['jobQueue']
  provenance: providerWorkflow['provenance']
}
